...
OUTPUT_SQL = os.path.join(DATA_DIR, f"merged_tasks_{lottery_type}.sql")
...
if __name__ == "__main__":
    ...
    if not sql_files:
        ...
        start_ids = {
            f"tasks_{lottery_type}": 1001,
            f"best_tasks_{lottery_type}": 501,
            f"best_ranks_{lottery_type}": 501,
        }
